...
export default function EditBlogPostPage() {
    ...
    useEffect(() => {
        ...
        Promise.all([fetchResources(), fetchPost()]);
    }, [id]);
            ...
            <div className="max-w-4xl mx-auto space-y-12">
                <form id="blog-form" onSubmit={handleSubmit} className="space-y-12">
                    ...
                    <div className="rounded-3xl border border-gray-100 bg-white p-8 dark:border-zinc-800 dark:bg-zinc-900 shadow-sm transition-all hover:shadow-md">
                        <h2 className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-6 font-bold">Fundamental Settings</h2>
                        ...
                        <div className="relative">
                            {contentBlocks.map((block, index) => (
                                <div key={index}>
                                    ...
                                    <div
                                        className={`group relative flex gap-4 items-start bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 rounded-3xl p-6 transition-all hover:border-red-200 shadow-sm hover:shadow-md ${draggedIndex === index ? 'opacity-50 border-red-500 scale-[0.98]' : ''}`}
                                    >
                                        <div
                                            draggable
