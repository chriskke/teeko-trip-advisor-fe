...
import { UserCog, Plus, Trash2, Key, Shield, Search, Loader2, X, Check, Copy } from "lucide-react";
...
export default function AdminManagementPage() {
    ...
    const togglePermission = (userId: string, permission: keyof Permissions) => {
        ...
        handleUpdatePermissions(userId, updatedPermissions);
    };
    ...
    const handleUpdatePermissions = async (userId: string, permissions: Permissions) => {
        try {
            ...
            if (res.ok) {
                setAdmins(prev => prev.map(a => a.id === userId ? { ...a, permissions } : a));
            }
        } catch (error) {
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-[10px] text-gray-400">Added on {new Date(admin.createdAt).toLocaleDateString()}</span>
                                                </div>
                                            </div>
                                        </td>
